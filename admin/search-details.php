...
$sql = "SELECT * from tblcontactdata where txnstatus ='Transaction Successful'and FullName like :skey ";
...
$sql = "SELECT * from tblcontactdata where txnstatus ='Transaction Successful'and PhoneNumber like :skey ";
$query = $dbh -> prepare($sql);
$query->bindParam(':skey',$srhkey,PDO::PARAM_STR);
...
// Search by email
if($srhby=='email'):
$sql = "SELECT * from tblcontactdata where txnstatus ='Transaction Successful'and EmailId like :skey ";
$query = $dbh -> prepare($sql);
$query->bindParam(':skey',$srhkey,PDO::PARAM_STR);
endif;
...
foreach($results as $result):
       ?>
                  ...
                  <td><?php echo htmlentities($result->txnid);?></td>
                  <td><?php echo htmlentities($result->txnstatus);?></td>
